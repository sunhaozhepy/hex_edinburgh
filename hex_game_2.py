...
def check_goal(current_shapes, goal_shape):
    current_set = set(current_shapes[0])
    goal_set = set(goal_shape)
    return current_set == goal_set
...
def print_two_boards(goal_shape, current_shapes):
    ...
    print(goal_str + "\n\n" + current_str)
    print("\na=add center, b=bar, c=corner, d=delete center, r=rotate, re=reflect, f=flip, w=west, q=quit")
